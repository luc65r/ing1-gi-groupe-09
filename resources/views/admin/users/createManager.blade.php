<x-app-layout>
    <x-slot name="header">
        ...
        <x-form id="formEtudiant" class="hidden" action="{{ route('admin.users.store') }}" method="POST">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <x-form id="formGestionnaire" class="hidden" action="{{ route('admin.users.store') }}" method="POST">
        ...
        <!-- 3e partie: Admin -->
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <x-form id="formAdmin" class="hidden" action="{{ route('admin.users.store') }}" method="POST">
